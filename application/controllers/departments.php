...
class Departments extends CI_Controller {
	...
	public function edit($department_id)
	{
		...
		$viewdata = array('departm'  => $department[0]);
	...
	public function index()
	{
		$thanhvien = $this->departments_m->get_thanhvien();

		$viewdata = array('thanhvien' => $thanhvien);

		$data = array('title' => 'Thành viên - PHÒNG TRỌ VIỆT', 'page' => 'departments');
		$this->load->view('header', $data);
		$this->load->view('departments/list',$viewdata);
		$this->load->view('footer');
	}
