...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2017 at 03:12 PM
...
`MaDP` int(5) NOT NULL,
  `TenNguoiDat` varchar(50) CHARACTER SET utf8 NOT NULL,
  `SDT` varchar(13) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `datphong` (`MaDP`, `TenNguoiDat`, `SDT`, `GhiChu`, `MaNT`, `NgayDat`) VALUES
(5, 'việt mập', '43435454545', '', 1, '2017-05-21'),
(6, 'Dương Tuấn Anh', '01672417012', '', 2, '2017-05-21'),
(7, 'fdfdfdf', '343434', '', 2, '2017-05-21'),
(9, 'fdfdf', 'fdfdf343434', '', 2, '2017-05-21');
...
(5, 4, '2017-05-08', 926000, 500000, 0, 426000, '2017-08-12'),
(6, 1, '2017-05-09', 909000, 400000, 0, 509000, '2017-06-12'),
(7, 7, '2017-05-09', NULL, NULL, NULL, NULL, NULL),
(8, 18, '2017-05-16', 464111, 11111, 0, 453000, '2018-11-11'),
(9, 4, '2017-06-14', 971000, 0, 426000, 1397000, '0000-00-00');
...
(5, 'fdsad', 1212121, 2),
(6, 'Phòng cũ', 800000, 5),
(7, 'Phòng mới', 1000000, 5),
(8, 'Phòng VIP', 1200000, 14),
(9, 'Phòng thường', 1000000, 14),
(10, 'PRO', 111111, 16),
(11, 'vip', 2147483647, 17);
...
`MaNT` int(5) NOT NULL,
  ...
  `TinhThanh` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `QuanHuyen` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `ViDo` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `KinhDo` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `DienTich` int(5) DEFAULT NULL,
...
INSERT INTO `nhatro` (`MaNT`, `TenNT`, `Username`, `Password`, `DiaChi`, `SDT`, `SoLuongPhong`, `TinhThanh`, `QuanHuyen`, `ViDo`, `KinhDo`, `DienTich`, `HinhAnh`, `MoTa`) VALUES
(1, 'Tuấn Việt', 'admin', 'admin', 'Trường Đại học Công nghệ Thông tin, Hồ Chí Minh, Việt Nam', '01672417012', 30, '79', '762', '10.87003790060074', '106.80521965026855', 20, 'img/phongtro1.jpg,img/phongtro2.png', 'Phòng đẹp'),
(2, 'Tuấn Anh', 'tanhdmt3', 'hoinghia12', 'Linh Trung, Hồ Chí Minh, Việt Nam', '343434535', 45, '79', '762', '10.868288864109225', '106.77545356724295', 20, 'img/phongtro3.jpg,img/phongtro4.jpg', 'Gần Làng đại học, sát trường Kinh tế-Luật. Khu vực đảm bảo an ninh. Internet tốc độ cao.'),
(3, 'FDSFG', 'as', 'as', NULL, NULL, NULL, '', '', '-34.397', '150.644', NULL, NULL, ''),
(4, 'quang', 'quang', 'quang', NULL, NULL, NULL, '', '', '-34.397', '150.644', NULL, NULL, ''),
(5, 'ABC', 'tanhdmt12', 'admin', NULL, NULL, NULL, '', '', '-34.397', '150.644', NULL, NULL, ''),
(14, 'HOÀNG VIỆT', 'tanh12', 'tanh', 'Cộng Hòa, Hồ Chí Minh, Tân Bình, Việt Nam', '888888883', 60, '79', '766', '10.803082541286733', '106.64759159088135', 20, NULL, 'Phòng đẹp'),
(16, 'quang1', 'quang1', 'quang1', 'Lê Văn Việt, Hiệp Phú, Hồ Chí Minh, Việt Nam', '545454545', 67, '79', '763', '10.846056242485467', '106.77865505218506', 20, NULL, ''),
(17, 'hviet', 'hviet', 'hviet', 'Hoàng Hoa Thám, Hồ Chí Minh, Việt Nam', '3123', 234, '79', '766', '10.801860050676861', '106.64883613586426', 12312, NULL, '');
...
(1, '2017-05-09', 'Đã thuê', NULL, 1, 2, ''),
(2, '2017-05-19', 'Đã thuê', NULL, 2, 2, ''),
(3, '2017-05-19', 'Đã thuê', NULL, 1, 2, ''),
(4, '2017-05-21', 'Đã thuê', NULL, 1, 1, ''),
(5, '2017-05-21', 'Đã thuê', '0000-00-00', 2, 1, ''),
(6, NULL, 'Trống', NULL, 1, 1, NULL),
(7, '2017-05-09', 'Đã thuê', NULL, 3, 4, ''),
(8, NULL, 'Trống', NULL, 4, 4, NULL),
(9, NULL, 'Trống', NULL, 2, 1, NULL),
(10, '2017-05-11', 'Đã thuê', NULL, 6, 5, ''),
(11, '2017-05-11', 'Đã thuê', NULL, 7, 5, ''),
(12, NULL, 'Trống', NULL, 6, 5, NULL),
(13, NULL, 'Trống', NULL, 6, 5, NULL),
(14, NULL, 'Trống', NULL, 6, 5, NULL),
(15, NULL, 'Trống', NULL, 1, 1, NULL),
(16, NULL, 'Trống', NULL, 8, 14, NULL),
(17, NULL, 'Trống', NULL, 8, 14, NULL),
(18, '2017-05-16', 'Đã thuê', NULL, 10, 16, ''),
(19, '2017-05-16', 'Trống', NULL, 11, 17, 'qweqwe'),
(20, NULL, 'Trống', NULL, 2, 1, NULL),
(21, NULL, 'Trống', NULL, 1, 1, NULL);
...
INSERT INTO `thanhvien` (`MaTV`, `TenTV`, `Sdt`, `CMND`, `GioiTinh`, `TinhTrang`, `MaPhong`, `ChucVu`, `NgayThue`, `NgayTra`) VALUES
(14, 'Dương Tuấn Anh', 43434, 3232, 'Nam', 'Không ở', 4, 'DD', NULL, '2017-05-16'),
(15, 'Phạm Thị Kiên', 4343, 4343, 'Nữ', 'Không ở', 4, 'TV', NULL, '2017-05-16'),
(16, 'Dương Tuấn Anh', 656753, 434, 'Nam', 'Đang ở', 1, 'DD', NULL, NULL),
(17, 'Dương Việt Anh', 3434435435, NULL, 'Nam', 'Đang ở', 1, 'TV', NULL, NULL),
(18, 'b', NULL, NULL, 'Nam', 'Đang ở', 7, 'DD', NULL, NULL),
(19, 'dfdfd', NULL, NULL, 'Nam', 'Đang ở', 7, 'TV', NULL, NULL),
(20, 'FDFD', NULL, NULL, 'Nam', 'Không ở', 5, 'DD', NULL, NULL),
(21, 'RTRT', NULL, NULL, 'Nam', 'Không ở', 5, 'TV', NULL, NULL),
(22, 'Dương Tuấn Anh', NULL, NULL, 'Nam', 'Không ở', 5, 'DD', NULL, NULL),
(23, 'Dương VA', NULL, NULL, 'Nam', 'Không ở', 5, 'DD', NULL, NULL),
(25, 'fdsfdf', NULL, NULL, 'Nam', 'Không ở', 5, 'DD', '2017-05-11', NULL),
(27, 'rewrewf', NULL, NULL, 'Nam', 'Không ở', 5, 'DD', '2017-05-11', '2017-05-11'),
(28, 'refg', NULL, NULL, 'Nam', 'Không ở', 4, 'TV', '2017-05-11', '2017-05-11'),
(29, 'fdfdf', NULL, NULL, 'Nam', 'Không ở', 5, 'DD', '2017-05-11', '2017-05-11'),
(30, 'Dương Tuấn Anh', NULL, NULL, 'Nam', 'Đang ở', 10, 'DD', '2017-05-11', NULL),
(31, 'gfgfg', NULL, NULL, 'Nam', 'Đang ở', 11, 'DD', '2017-05-11', NULL),
(32, 'VIET', 113, 225131241, 'Nam', 'Đang ở', 18, 'DD', '2017-05-16', NULL),
(33, 'ANH', 15124, 1551243, 'Nam', 'Đang ở', 18, 'TV', '2017-05-16', NULL),
(34, 'viwtr', NULL, NULL, 'Nam', 'Không ở', 19, 'DD', '2017-05-16', '2017-05-16'),
(35, 'ewrr', 234234, 543523452, 'Nam', 'Không ở', 19, 'TV', '2017-05-16', '2017-05-16'),
(36, 'Dương Tuấn Anh', NULL, NULL, 'Nam', 'Không ở', 4, 'DD', '2017-05-18', '2017-05-21'),
(37, 'fdf', NULL, NULL, 'Nam', 'Đang ở', 2, 'DD', '2017-05-19', NULL),
(38, 'fdfdf', NULL, NULL, 'Nam', 'Đang ở', 3, 'DD', '2017-05-19', NULL),
(39, 'dsjAHDB123123', NULL, NULL, 'Nam', 'Đang ở', 1, 'TV', '2017-05-21', NULL),
(41, 'bc', NULL, NULL, 'Nam', 'Đang ở', 5, 'DD', '2017-05-21', NULL),
(42, 'ffgg', 1672417012, NULL, 'Nam', 'Đang ở', 4, 'DD', '2017-05-21', NULL),
(43, '65656tyty', 0, NULL, 'Nam', 'Không ở', 4, 'TV', '2017-05-21', '2017-05-21'),
(44, 'gfgfgf', NULL, NULL, 'Nam', 'Không ở', 4, 'TV', '2017-05-21', '2017-05-21'),
(45, 'fdfdf', NULL, NULL, 'Nam', 'Không ở', 4, 'TV', '2017-05-21', '2017-05-21'),
(46, 'bc2', NULL, NULL, 'Nam', 'Không ở', 4, 'TV', '2017-05-21', '2017-05-21'),
(47, 'gfGFG', NULL, NULL, 'Nam', 'Không ở', 4, 'TV', '2017-05-21', '2017-05-21'),
(48, 'ggfg', 0, 0, 'Nam', 'Không ở', 4, 'TV', '2017-05-21', '2017-05-21'),
(49, 'fdfdfdf', 4554455454, 2147483647, 'Nam', 'Không ở', 4, 'TV', '2017-05-21', '2017-05-21');
...
ALTER TABLE `datphong`
 ADD PRIMARY KEY (`MaDP`), ADD KEY `MaNT` (`MaNT`);
...
--
ALTER TABLE `nhatro`
 ADD PRIMARY KEY (`MaNT`), ADD UNIQUE KEY `Username` (`Username`), ADD UNIQUE KEY `SDT` (`SDT`);
...
--
ALTER TABLE `chiphish`
MODIFY `MaCP` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT for table `datphong`
--
ALTER TABLE `datphong`
MODIFY `MaDP` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `dien`
--
ALTER TABLE `dien`
MODIFY `MaDien` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `hoadon`
--
ALTER TABLE `hoadon`
MODIFY `MaHD` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `loaiphong`
--
ALTER TABLE `loaiphong`
MODIFY `MaLoaiPhong` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `nhatro`
--
ALTER TABLE `nhatro`
MODIFY `MaNT` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `nuoc`
--
ALTER TABLE `nuoc`
MODIFY `MaNuoc` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `phongtro`
--
ALTER TABLE `phongtro`
MODIFY `MaPhong` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT for table `thanhvien`
--
ALTER TABLE `thanhvien`
MODIFY `MaTV` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
...
--
ALTER TABLE `datphong`
ADD CONSTRAINT `datphong_ibfk_1` FOREIGN KEY (`MaNT`) REFERENCES `nhatro` (`MaNT`);
